    ...
    <!-- Conteúdo da página -->
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Cadastrar Professor a turma</h1>
          </div>
          <form action="../DAO/insertProfTurma.php" method="POST" enctype="multipart/form-data">
            <div class="container">
              ...
              <h5>Professores:</h5>
                <select class="form-control" name="email" >
                    <?php
                      ...
                      $query= "SELECT email,nome FROM PROFESSOR ";
          ...
          <div class="table-responsive">
            ...
            <thead>
              ...
              <?php
                include_once "../DAO/conexao.php";
                $query= "SELECT * FROM ministra ORDER BY `email` ASC";
                $consulta= mysqli_query($conexao,$query);
